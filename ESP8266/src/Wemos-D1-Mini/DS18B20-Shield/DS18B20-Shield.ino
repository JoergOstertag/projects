/**
 * Taken from the example of the library.
 * It shows details about every DS18B20 Sensor attached.
 * For the Wemos D1-Mini SHield it normally is exactly one Sensor
 * 
 */
